            ...
            child: ElevatedButton(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    SvgPicture.asset('assets/images/ic-marketing.svg'),
                    const Text('Chỉ tiêu', style: TextStyle(color: Color(0xFF289767))),
                  ]
                )
              )
            )
              ...
              child: const Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Phê Duyệt', style: TextStyle(color: Colors.grey))
                  ]
                )
              )
            )
